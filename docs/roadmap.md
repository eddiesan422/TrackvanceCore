...
| 10 | Data Delivery controlado a PostgreSQL/SQL Server | Implementado y certificado localmente en 0.5.0; CI del commit se registra por separado |
...
producto. La certificación de 0.5.0 se publica separada de este estado funcional.
