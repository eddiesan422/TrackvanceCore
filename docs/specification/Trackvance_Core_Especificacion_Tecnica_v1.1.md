...
El primer workflow 35488396043 aprobó cinco de seis jobs, pero backup falló en Linux. El helper se ejecutaba como usuario trackvance e intentaba escribir sobre un bind del host con permisos 0755 de otro propietario; el sistema devolvió PermissionError 13. La causa se reprodujo y se corrigió transportando el tar por stdout/stdin con archivos privados abiertos en el host. No se relajaron permisos del host ni se ejecutó el helper como root. Pasaron 48 pruebas focalizadas, la suite completa de 533 tests y el drill real de recuperación por streaming.

La corrección quedó certificada en GitHub Actions: workflow 35488848150, commit a03d87ecb051d88abfe57111ae90853f9dcbcf66, resultado SUCCESS en seis de seis jobs: backend, frontend, compose-e2e, connections-e2e, backup-restore-e2e y benchmark-smoke. El job de backup verificó siete artifacts, un secreto y 124 relaciones. Backend aprobó 533 tests, Ruff, Mypy y migraciones; frontend aprobó sus 109 tests, lint, tipos y build. Los escenarios opt-in de navegador se cubrieron en los jobs correspondientes. El benchmark smoke valida el runner con carga pequeña; el volumen local de 100 MiB conserva su certificación independiente. La URL verificable del workflow figura en la tabla de resultados; el fallo inicial permanece documentado como incidencia corregida.
